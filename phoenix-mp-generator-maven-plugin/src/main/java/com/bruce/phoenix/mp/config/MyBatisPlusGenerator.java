...
import com.bruce.phoenix.mp.config.file.*;
    ...
    public InjectionConfig initInjectionConfig() {
        return new InjectionConfig() {
            ...
            public void initMap() {
                ...
                map.put(PROJECT_NAME, mpConfig.getProjectName());
                ...
                if (mpConfig.isFirstInit()) {
                    ...
                    fileOutConfigList.add(new YmlConfig("/templates/custom/yml.vm", joinPath(mpConfig.getOutputDir(mpConfig.getModuleName()), mpConfig.getPackageConfig().getParent())));
